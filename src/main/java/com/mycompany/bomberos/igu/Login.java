...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BOMBEROS VOLUNTARIOS LOS JURIES");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon("/home/pablo/NetBeansProjects/IMAGENES/images.png")); // NOI18N

        btnInicio.setFont(new java.awt.Font("Liberation Sans", 0, 18)); // NOI18N
        ...
        txtUser.setFont(new java.awt.Font("Liberation Sans", 0, 24)); // NOI18N

        txtPass.setFont(new java.awt.Font("Liberation Sans", 0, 24)); // NOI18N
    ...
    private void Validar() {
        String user = "b";
        String pas = "s";
        if (txtUser.getText().equalsIgnoreCase(user) && txtPass.getText().equalsIgnoreCase(pas)){
